...
#define RS485_CTRL_GPIO_Port GPIOD
#define TCP_CFG_Pin GPIO_PIN_15
#define TCP_CFG_GPIO_Port GPIOA
#define TCP_RST_Pin GPIO_PIN_4
#define TCP_RST_GPIO_Port GPIOB
