...
// SDA on port B, bit 7
#define SDA_LOW()  HAL_GPIO_WritePin(IIC1_SDA_GPIO_Port,IIC1_SDA_Pin,GPIO_PIN_RESET) 	// set SDA to low
#define SDA_OPEN() HAL_GPIO_WritePin(IIC1_SDA_GPIO_Port,IIC1_SDA_Pin,GPIO_PIN_SET)		// set SDA to open-drain
#define SDA_READ   HAL_GPIO_ReadPin(IIC1_SDA_GPIO_Port,IIC1_SDA_Pin)									// read SDA

// SCL on port B, bit 6              /* -- adapt the defines for your uC -- */
#define SCL_LOW()  HAL_GPIO_WritePin(IIC1_SCL_GPIO_Port,IIC1_SCL_Pin,GPIO_PIN_RESET)	// set SCL to low
#define SCL_OPEN() HAL_GPIO_WritePin(IIC1_SCL_GPIO_Port,IIC1_SCL_Pin,GPIO_PIN_SET)		// set SCL to open-drain
#define SCL_READ   HAL_GPIO_ReadPin(IIC1_SCL_GPIO_Port,IIC1_SCL_Pin)									// read SCL
